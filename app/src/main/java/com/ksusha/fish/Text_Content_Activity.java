...
import static com.ksusha.fish.R.color.background;
...
public class Text_Content_Activity extends AppCompatActivity {
    ...
    private String [] array_ukr_litra = {
    ...
    private int [] array_nagolosi = { R.string.nagolosi, };
    private String [] array_nagolosy = { "Наголоси.", };
    @Override
    ...
    private void init(){
        ...
        face1 = Typeface.createFromAsset(this.getAssets(), "fonts/Bitter-Regular.ttf");
